...
- `session` - text, session alias  **Required**. Example: `arfq02fix10`
- `dictionary` - text, name of dictionary for parsing the message  **Required**. Example: `fix50-trm2`
